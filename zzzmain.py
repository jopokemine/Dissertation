...
def parse():
    ...
    parser.add_argument('-D', '--dataset', default='cornell', help='Comma separated list of dataset(s) to use. Options (case-sensitive) are: amazon, cornell, convai, opensubtitles, QA, rsics, twitter, ubuntu, squad')
